...
<section class="container flex-grow mx-auto max-w-[1200px] border-b py-5 lg:flex lg:flex-row lg:py-10">
            ...
            <div class="w-full">
                <div class="flex w-full">
                    <div class="flex flex-col gap-2">
                        <a href="account-page.html" class="flex items-center gap-2 font-medium active:text-violet-900">
    ...
    <section class="hidden w-full max-w-[1200px] grid-cols-1 gap-8 px-5 pb-10 md:grid">
        ...
        <div class="flex w-full h-44 flex-row items-center justify-between border py-5 px-4">
            <div class="flex w-full items-center gap-4">
                <img width="100px" class="object-cover" src="./assets/images/bedroom.png" alt="Bedroom image" />
        ...
        <div class="flex w-full h-44 flex-row items-center justify-between border py-5 px-4">
            <div class="flex w-full items-center gap-4">
                <img width="100px" class="object-cover" src="./assets/images/living-room.png" alt="Sofa image" />
        ...
        <div class="flex w-full h-44 flex-row items-center justify-between border py-5 px-4">
            <div class="flex w-full items-center gap-4">
                <img width="100px" class="object-cover" src="./assets/images/product-chair.png" alt="Chair image" />
