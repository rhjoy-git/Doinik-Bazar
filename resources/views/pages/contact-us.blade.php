...
<div class="container w-full max-w-[1200px] mx-auto px-4 py-8">
    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-700"><strong>Address:</strong> Mirpur, Dhaka, Bangladesh</p>
            <p class="text-gray-700"><strong>Phone:</strong> +880 1234-56789</p>
            <p class="text-gray-700"><strong>Email:</strong> info@endbrackets.com</p>
        </div>
