<section class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    ...
    <div class="mb-4 grid grid-cols-2 gap-3 px-5 md:grid-cols-3 lg:grid-cols-4">
    ...
    <div class="flex justify-center justify-items-center mt-10">
        <a href="{{ route('all-products') }}"
            class="text-black max-w-32 w-28 border hover:scale-105 hover:border-2 border-violet-800 hover:border-violet-900 font-medium text-sm px-5 py-2.5 focus:outline-none text-center mx-auto transition">
            View All
        </a>
    </div>
    @endif
