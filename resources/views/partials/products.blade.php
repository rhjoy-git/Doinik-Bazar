...
<section class="container w-full max-w-screen-xl mx-auto pb-10">
    ...
    <div class="flex justify-center justify-items-center mt-5:">
        ...
        class="text-black max-w-32 w-28 border hover:scale-105 hover:border-2 border-violet-800 hover:border-violet-900 font-medium text-sm px-5 py-2.5 focus:outline-none text-center mx-auto transition">View
        All</a>
    </div>
