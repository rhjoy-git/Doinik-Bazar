        ...
        <section class="grid w-full max-w-screen-xl grid-cols-1 gap-3 px-5 pb-10">
            <table class="hidden lg:table">
                <thead class="h-16 bg-neutral-100">
                    <tr id="checkout">
                        <th class="" id="address">ADDRESS</th>
                        <th class="" id="delivery-method">DELIVERY METHOD</th>
                        <th class="" id="payment-method">PAYMENT METHOD</th>
                        <th class="" id="order-review">ORDER REVIEW</th>
                    </tr>
                </thead>
            </table>
